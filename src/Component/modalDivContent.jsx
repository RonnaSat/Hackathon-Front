                                                ...
                                                <div class="col m-1">
                                                    <div className="col mb-3">
                                                        ...
                                                        <div className="form-floating mb-3">
                                                            <input onChange={handChange(setProductName)} defaultValue={product.productName} type="text" className="form-control" id="floatingInput" placeholder="name@example.com" />
